...
# Create layout of 2 x 2 graphs
par(mfrow=c(2,2))

# Create necessary plots
# Plot 1
plot(myPD$DateTime, myPD$Global_active_power, type="l", xlab = "", ylab = "Global Active Power")

# Plot 2
plot(myPD$DateTime, myPD$Voltage, type="l", xlab = "datetime", ylab = "Voltage")

# Plot 3
plot(myPD$DateTime, myPD$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
lines(myPD$DateTime, myPD$Sub_metering_2, col="red")
lines(myPD$DateTime, myPD$Sub_metering_3, col="blue")
legend("topright", col=c("black","red","blue"), c("Sub_metering_1 ","Sub_metering_2 ", "Sub_metering_3 "),lty=c(1,1), lwd=c(1,1))


# Plot 4
plot(myPD$DateTime, myPD$Global_reactive_power, type="l", xlab = "datetime", ylab = "Global_reactive_power")
